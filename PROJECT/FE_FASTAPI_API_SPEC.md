...
| cardPrefix | string \| null | 카드 앞 4자리. **0000**=현금, **1000**=카드번호 없음/****, 그 외=실제 **앞 4자리** |
...
| extracted_data | object \| null | store_name, amount, pay_date, address, card_num(0000=현금, 1000=카드없음, 4자리=앞 4자리) |
